            ...
            <div class="document">
                ...
                <div class="document_main">
                    <?php 
                        ...
                        where s.id =1 ORDER BY created_at DESC LIMIT 4 OFFSET $offset;";
                ...
                <a href="detail.php">
                    <div class="document_main">
                        <?php 
                            ...
                            JOIN users u ON d.user_id = u.id where s.id =1 ORDER BY download_count DESC 
                ...
                <div class="document_main">
                    <?php 
                        ...
                        where s.id =1 ORDER BY view_count DESC LIMIT 4 OFFSET $offset;";
                ...
                <div class="document_main">
                    <?php 
                        $sql_recent="SELECT d.* ,s.name as 'ten_mon', u.name as 'ten_user' FROM subjects s JOIN documents d ON s.id = d.subject_id JOIN users u ON d.user_id = u.id
                        where s.id =1 ORDER BY download_count DESC LIMIT 4 OFFSET $offset;";
                        $result_recent= mysqli_query($conn,$sql_recent);
                        while($row_recent= mysqli_fetch_array($result_recent)){
                    ?>
                    <a href="detail.php">
                ...
                <div class="pagination">
                    <?php 
                        $sql_page= "SELECT COUNT(id) as 'count' FROM documents WHERE subject_id=1;";
