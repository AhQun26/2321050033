    ...
    <div class="header">
        ...
        <div class="header_feature">
            ...
            <div class="header_feature_account">
                <a href="abc.php"><i href="" class="fa-regular fa-bell"></i></a>
                <a href="abc.php"><i href="" class="avatar"><img src="../../../assets/images/avatar/default.jpg" alt=""></i></a>
            </div>
        </div>
    </div>
    <div class="main_left">
